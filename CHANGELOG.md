...
- Break file loading into two steps, so that the mapping step occurs after all of the
  file data is loaded. This improves performance when there are thousands of files.
